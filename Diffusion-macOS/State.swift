...
class GenerationContext: ObservableObject {
    ...
    @Published var isSubmtBTNBusy=false
    @Published var positivePrompt = DEFAULT_PROMPT
    @Published var negativePrompt = ""
    @Published var positivePrompt2 = ""
    @Published var positivePrompt3 = ""
    @Published var positivePrompts: [String] = [DEFAULT_PROMPT,DEFAULT_PROMPT]
    @Published var generatedImages: [CGImage] = []
    @Published var generatedImagesInfo: [String] = []
